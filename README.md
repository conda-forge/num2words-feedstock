...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/num2words-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11353&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/num2words-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `num2words` can be installed with:

```
conda install num2words
```

It is possible to list all of the versions of `num2words` available on your platform with:
